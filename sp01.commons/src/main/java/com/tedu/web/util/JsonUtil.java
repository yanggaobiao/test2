...
public class JsonUtil {
    ...
    public static <V> V from(File file, Class<V> c) {
        try {
            ...
            log.error("jackson from error, file path: {}, type: {}", file.getPath(), c,
                    e);
            return null;
        }
    }
    public static <V> V from(Object jsonObj, Class<V> c) {
        try {
            ...
            log.error("jackson from error, json: {}, type: {}", jsonObj.toString(), c,
                    e);
            return null;
        }
    }
    ...
    public static <V> V from(File file, TypeReference<V> type) {
        try {
            ...
            log.error("jackson from error, file path: {}, type: {}", file.getPath(),
                    type, e);
            return null;
        }
    }
    public static <V> V from(Object jsonObj, TypeReference<V> type) {
        try {
            ...
            log.error("jackson from error, json: {}, type: {}", jsonObj.toString(), type,
                    e);
            return null;
        }
    }
    ...
    public static <T> String add(String json, String key, T value) {
        try {
            ...
            log.error("jackson add error, json: {}, key: {}, value: {}", json, key,
                    value, e);
            return json;
        }
    }
    ...
    public static <T> String update(String json, String key, T value) {
        try {
            ...
            log.error("jackson update error, json: {}, key: {}, value: {}", json, key,
                    value, e);
            return json;
        }
    }
